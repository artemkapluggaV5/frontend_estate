...
const FeaturedCategories: React.FC = () => {
  ...
  return (
    <section style={{ marginBottom: '4rem' }}>
      <h2 style={{ fontSize: '2rem', fontWeight: 700, marginBottom: '2rem' }}>Купить недвижимость в Краснодарском крае</h2>
      <div className="categories-grid">
        <div className="category-card-1" style={{ position: 'relative', borderRadius: 'var(--radius)', overflow: 'hidden', cursor: 'pointer' }} onClick={() => navigate('/catalog?category=Новостройка')}>
        ...
        <div className="category-card-2" style={{ position: 'relative', borderRadius: 'var(--radius)', overflow: 'hidden', cursor: 'pointer' }} onClick={() => navigate('/catalog?category=Вторичка')}>
        ...
        <div className="category-card-3" style={{ position: 'relative', borderRadius: 'var(--radius)', overflow: 'hidden', cursor: 'pointer' }} onClick={() => navigate('/catalog?category=Коммерция')}>
        ...
        <div className="category-card-4" style={{ position: 'relative', borderRadius: 'var(--radius)', overflow: 'hidden', cursor: 'pointer' }} onClick={() => navigate('/catalog?category=Дом')}>
