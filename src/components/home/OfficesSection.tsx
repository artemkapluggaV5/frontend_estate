...
const OfficesSection: React.FC = () => {
  return (
    <section style={{ marginBottom: '4rem' }}>
      <h2 style={{ fontSize: '2.5rem', fontWeight: 800, marginBottom: '2rem', textAlign: 'center' }}>Наш офис в Краснодарском крае</h2>
      <div className="split-card" style={{ boxShadow: 'var(--shadow-lg)' }}>
        <div className="split-card-content">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', color: 'var(--text-light)' }}>
            ...
            <p><strong>Телефон:</strong><br/> +7 (951) 717-73-24</p>
