  ...
  return (
    <section style={{ marginBottom: '4rem' }}>
      ...
      <div style={{
        ...
        <div style={{ gridColumn: 'span 2', gridRow: 'span 2', position: 'relative', borderRadius: 'var(--radius)', overflow: 'hidden' }}>
        ...
        <div style={{ gridColumn: 'span 1', gridRow: 'span 2', position: 'relative', borderRadius: 'var(--radius)', overflow: 'hidden' }}>
        ...
        <div style={{ gridColumn: 'span 1', gridRow: 'span 1', position: 'relative', borderRadius: 'var(--radius)', overflow: 'hidden' }}>
